"""
Django settings for Makola Marketplace project.
"""
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@makolamarketplace.com')

# Stripe Configuration (DISABLED - Shopping List mode only)
...
# Railway handles HTTPS automatically, so we don't force SSL redirect
if not DEBUG:
    # SECURE_SSL_REDIRECT = True  # Disabled - Railway handles HTTPS
